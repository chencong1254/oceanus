...
*/
      ...
      public void handleMessage(Message msg) {
        ...
        /* handle subtitle msg */
          ...
          case SCRAMBLED_AUDIO_NO_VIDEO_SVC:
          {
            ...
            Log.d(TAG, "notifyVideoUnavailable,reason : VIDEO_UNAVAILABLE_REASON_TUNING");
            break;
          }
  ...
  public int notifySubtitleMsg(int msg_id, int argv1, int argv2, int argv3) {
    ...
    else if (msg_id == MtkTvSubtitleBase.SubtitleCallBackType
             .SUBTITLE_CALL_BACK_TYPE_TRACK_INFO_SELECTED.ordinal()) {
